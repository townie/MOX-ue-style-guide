# MOX Unreal Engine Style Guide Version

# *A mostly reasonable approach to Unreal Engine 5*

Heavily inspired by the [Allar/ue5-style-guide](https://github.com/Allar/ue5-style-guide).
...
<a name="2e1"><a>
### 2e1 MOX Project Content Structure
<pre>
|-- Content
